...
CASES: list[dict[str, Any]] = [
    ...
    {"id": "numeric-08", "text": "生成时把分辨率调到 2K，画面会更清晰", "intent": "numeric-metric", "eventType": "dataPunch", "eventTextContains": "2K"},
    {"id": "numeric-09", "text": "我更推荐先生成 1k 视频", "intent": "numeric-metric", "eventType": "dataPunch", "eventTextContains": "1K"},
    ...
    {"id": "transform-01", "text": "从一个人变成一个团队，关键是第二大脑", "intent": "transformation-stack", "eventType": "captionHighlight"},
    {"id": "transform-02", "text": "知识库会变成你的护城河和能力杠杆", "intent": "transformation-stack", "eventType": "captionHighlight"},
    {"id": "transform-03", "text": "AI 把你的经验转化成可复制流程", "intent": "transformation-stack", "eventType": "captionHighlight"},
    {"id": "transform-04", "text": "它不是替代你，而是放大你的能力", "intent": "transformation-stack", "eventType": "captionHighlight"},
    {"id": "transform-05", "text": "从个人知识变成团队资产", "intent": "transformation-stack", "eventType": "captionHighlight"},
    {"id": "transform-06", "text": "真正的杠杆，是把一次经验变成长期系统", "intent": "transformation-stack", "eventType": "captionHighlight"},
    {"id": "transform-07", "text": "通过自动化推动升级，把个人经验变成团队流程，最终实现稳定交付", "intent": "transformation-stack", "eventType": "transformationStack", "eventTextContains": "个人经验 → 团队流程"},
    ...
    {"id": "future-preview-01", "text": "下一期我会介绍如何用 Codex 自动剪辑", "intent": "explanation-claim", "eventType": "claimStrip"},
    {"id": "future-preview-02", "text": "下期将拆解数字人自动剪辑流程", "intent": "explanation-claim", "eventType": "claimStrip"},
    ...
    {"id": "real-project-flow-transform", "text": "不是它会写代码，而是你把一个麻烦事交给它，它真的能把整套流程跑通。", "intent": "transformation-stack", "eventType": "captionHighlight"},
